...
describe("Check Date tests", () => {
	it("Check Date tests", () => {
		...
		expect(check("2020-01-01T12:35", "2020-01-01T12:45:45.8")).toEqual({
			start: "2020-01-01T12:35:00.000Z",
			end: "2020-01-01T12:45:45.899Z",
		})
		expect(check("2020-01-01T12:35", "2020-01-01T12:45:45.888ZNO")).toEqual({
			start: "2020-01-01T12:35:00.000Z",
			end: undefined,
		})
	})
